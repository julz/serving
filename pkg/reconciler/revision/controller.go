...
func newControllerWithOptions(
	...
	digestTransport := http.DefaultTransport
	...
	resolver := newBackgroundResolver(logger, &digestResolver{client: kubeclient.Get(ctx), transport: digestTransport}, impl.EnqueueKey)
